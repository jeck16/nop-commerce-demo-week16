...
public class DesktopsPage extends Utility {
    ...
    public void clickOnBuildYourComp() {
        log.info("Click on build your own computer" + buildYourComp.toString());//CustomListeners.test.log(Status.PASS, "Click on build your own computer" + buildYourComp.toString());
